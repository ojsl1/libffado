...
#define RME_FF800_FLASH_MIXER_SHADOW_SIZE   0x00002000
...
#define FF_DEV_FLASH_BWLIMIT_SEND_ALL_CHANNELS 0x00000000
#define FF_DEV_FLASH_BWLIMIT_NO_ADAT2          0x00000001  // FF800 only
#define FF_DEV_FLASH_BWLIMIT_ANALOG_SPDIF_ONLY 0x00000002
#define FF_DEV_FLASH_BWLIMIT_ANALOG_ONLY       0x00000003
...
#define FF_DEV_FLASH_SYNCREF_WORDCLOCK         0x00000003
#define FF_DEV_FLASH_SYNCREF_ADAT1             0x00000000
#define FF_DEV_FLASH_SYNCREF_ADAT2             0x00000001
#define FF_DEV_FLASH_SYNCREF_SPDIF             0x00000002
#define FF_DEV_FLASH_SYNCREC_TCO               0x00000004  // To be confirmed
