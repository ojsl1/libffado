...
#ifndef DICE_PRESONUS_FIRESTUDIO_PROJECT_H
#define DICE_PRESONUS_FIRESTUDIO_PROJECT_H
...
private:
    class FirestudioProjectEAP : public Dice::EAP
    {
    public:
        FirestudioProjectEAP(Dice::Device& dev) : Dice::EAP(dev) {
}
