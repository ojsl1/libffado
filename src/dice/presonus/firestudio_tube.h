...
#ifndef DICE_PRESONUS_FIRESTUDIO_TUBE_H
#define DICE_PRESONUS_FIRESTUDIO_TUBE_H
...
private:
    class FirestudioTubeEAP : public Dice::EAP
    {
    public:
        FirestudioTubeEAP(Dice::Device& dev) : Dice::EAP(dev) {
}
